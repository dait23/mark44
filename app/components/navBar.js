...
const IconBars = (<Fa name="bars" size={26} color="#d80620" />);
const IconLeft = (<Fa name="chevron-left" size={26} color="#d80620" />);
    ...
    let renderLeftContent = () => {
      ...
      if (index > 0) {
        return <RkButton
          ...
          <RkText rkType='awesome hero'>{IconLeft}</RkText>
        </RkButton>
      }
      else {
        return <RkButton
          ...
          <RkText rkType='awesome'>{IconBars}</RkText>
        </RkButton>
      }
    };
